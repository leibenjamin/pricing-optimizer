...
export const PRESETS: Preset[] = [
  {
    ...
    optRanges: { good: [11.5, 13.5], better: [22, 28], best: [48, 58], step: 0.5 },
    optConstraints: {
      gapGB: 3,
      gapBB: 10,
  ...
  },
  {
    ...
    priceRange: {
      good: { min: 26, max: 36 },
      better: { min: 50, max: 78 },
      best: { min: 98, max: 132 },
    },
    priceRangeSource: "shared",
    optRanges: { good: [28, 34], better: [54, 72], best: [106, 128], step: 2 },
    optConstraints: {
      gapGB: 5,
      gapBB: 11,
      marginFloor: { good: 0.28, better: 0.34, best: 0.42 },
      charm: false,
      usePocketMargins: true,
      usePocketProfit: true,
      maxNoneShare: 0.85,
