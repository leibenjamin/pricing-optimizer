...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    segments: [
      { name: "Bargain hunters", weight: 0.40, betaPrice: -0.36, betaFeatA: 0.35, betaFeatB: 0.18, betaNone: 0.16, alphaAnchor: 0.12, lambdaLoss: 1.45 },
      { name: "Omni shopper", weight: 0.35, betaPrice: -0.24, betaFeatA: 0.55, betaFeatB: 0.50, betaNone: 0.04, alphaAnchor: 0.12, lambdaLoss: 1.4 },
      { name: "Premium gifter", weight: 0.25, betaPrice: -0.18, betaFeatA: 0.85, betaFeatB: 0.75, betaNone: -0.24, alphaAnchor: 0.10, lambdaLoss: 1.35 },
    ],
    channelMix: [
    ...
    priceRange: {
      good: { min: 26, max: 38 },
      better: { min: 50, max: 82 },
      best: { min: 98, max: 138 },
    },
    priceRangeSource: "shared",
    optRanges: { good: [28, 36], better: [54, 78], best: [106, 132], step: 2 },
    optConstraints: {
      gapGB: 4.5,
      gapBB: 10,
      marginFloor: { good: 0.26, better: 0.32, best: 0.4 },
      charm: false,
      usePocketMargins: true,
      usePocketProfit: true,
      maxNoneShare: 0.85,
