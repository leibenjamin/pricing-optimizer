...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    refPrices: { good: 30, better: 58, best: 115 },
    features: {
      featA: { good: 1, better: 1, best: 1 },
      featB: { good: 0, better: 1, best: 1 },
    },
    ...
    segments: [
      ...
      { name: "Premium gifter", weight: 0.25, betaPrice: -0.15, betaFeatA: 0.85, betaFeatB: 0.75, betaNone: -0.08, alphaAnchor: 0.06, lambdaLoss: 1.22 },
    ],
    channelMix: [
    ...
    leak: (() => {
      ...
      return {
        ...blended,
        promo: { good: 0.08, better: 0.06, best: 0.05 },
        volume: { good: 0.04, better: 0.03, best: 0.02 },
        fxPct: 0.025,
        refundsPct: 0.03,
      };
    })(),
    priceRange: {
      good: { min: 24, max: 40 },
      better: { min: 46, max: 86 },
      best: { min: 100, max: 148 },
    },
    priceRangeSource: "shared",
    optRanges: { good: [26, 36], better: [50, 78], best: [110, 140], step: 2 },
    optConstraints: {
      gapGB: 2.5,
      gapBB: 6,
      marginFloor: { good: 0.22, better: 0.28, best: 0.36 },
      charm: false,
      usePocketMargins: true,
      usePocketProfit: true,
      maxNoneShare: 0.9,
  ...
  },
  {
    ...
    costs: { good: 0, better: 0.8, best: 1.2 },
    ...
    optConstraints: {
      gapGB: 2,
      gapBB: 4,
      marginFloor: { good: 0, better: 0.35, best: 0.4 },
      charm: true,
      usePocketMargins: false,
      usePocketProfit: true,
      maxNoneShare: 0.95,
